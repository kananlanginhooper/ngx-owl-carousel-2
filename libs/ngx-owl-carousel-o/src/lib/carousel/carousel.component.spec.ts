...
import { CarouselComponent, CarouselSlideDirective, SlidesOutputData } from './carousel.component';
...
describe('CarouselComponent', () => {
    ...
    beforeEach(
        waitForAsync(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CarouselComponent, TestComponent, HashComponent, CarouselSlideDirective, StageComponent],
                providers: [
                    ResizeService,
                    WINDOW_PROVIDERS,
                    OwlLogger,
    ...
    it(
        'should render carousel with slides keeping default values',
        waitForAsync(() => {
            const html = `
    ...
    it(
        `should render carousel with 4 active slides [options]="{items: '4'}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with 3 active slides when prop items isn't number: [options]="{items: 'four'}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with 5 active slides when prop items=10 and there're just 5 slides: [options]="{items: '10'}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
  ...
  and each slide has width of 10th part of <owl-carousel-o> [options]="{items: '10', skip_validateItems: true}"`, fakeAsync(() => {
    ...
    it(
        `should render carousel with 2 active slides and 6 cloned slide (total slides 11) [options]="{items: 2, loop: true}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with 2 active slides and 6 cloned slide (total slides 11) [options]="{items: 2, loop: true, rewind: false}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with 5th active slide and 1 cloned active slide (total slides 11)
       [options]="{items: 2, loop: true, startPosition: 4} (startPosition: 4 is array-like index)`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with 2th active slide [options]="{items: 2, startPosition: 1}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with 4th active slide not 5th[options]="{items: 2, startPosition: 4}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel which has 1th slide with class .center [options]="{items: 2, center: true}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel which has 3th slide with class .center [options]="{items: 2, center: true, startPosition: 2}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel which doesn\'t have class .owl-drag [options]="{items: 1, mouseDrag: false}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with slides having 'margin-right=10px' [options]="{items: 2, margin: 10}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with .owl-rtl [options]="{items: 2, rtl: true}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with slides having 'margin-left=10px' [options]="{items: 2, margin: 10, rtl: true}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with class .owl-rtl and active slides starting from 2 position [options]="{items: 2, startPosition: 2, rtl: true}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with class .owl-rtl, active slides starting from 2nd position and first of active slide should have .center  [options]="{items: 3, startPosition: 2, rtl: true}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should set paddings to .owl-stage  [options]="{items: 3, loop: true, stagePadding: 40}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    describe(`THE OPTION 'MERGE'`, () => {
        it(
            `should render carousel with option merge (in fact this option does almost nothing; we should use data-binding to directive carouselSlide: [dataMerge]="2") [options]="{merge: true}`,
            waitForAsync(() => {
                const html = `
        <div style="width: 1200px; margin: auto">
      ...
      `;
        ...
        it(
            `should limit width of slide with [dataMerge]="4" by 2 widths of common slide [options]="{items: 2, merge: true}`,
            waitForAsync(() => {
                const html = `
        <div style="width: 1200px; margin: auto">
      ...
      `;
        ...
        it(
            `shouldn\'t limit width of slide with [dataMerge]="4" by 2 widths of common slide [options]="{mergeFit: false, items: 2, merge: true}`,
            waitForAsync(() => {
                const html = `
        <div style="width: 1200px; margin: auto">
      ...
      `;
            ...
            deSlides = deCarouselComponent.queryAll(By.css('.owl-item'));
            expect(deSlides[0].nativeElement.clientWidth).toBe(268, 'width of 1th slide is twice bigger then common slide');
            expect(deSlides[1].nativeElement.clientWidth).toBe(134, 'width of 2th slide should be 400 (402/3=134)');
            expect(deSlides[2].nativeElement.clientWidth).toBe(268, 'width of 3th slide is twice bigger then common slide');
        }));
      ...
      `;
            ...
            deSlides = deCarouselComponent.queryAll(By.css('.owl-item'));
            expect(deSlides[0].nativeElement.clientWidth).toBe(402, 'width of 1th slide is twice bigger then common slide');
            expect(deSlides[1].nativeElement.clientWidth).toBe(134, 'width of 2th slide should be 400 (402/3=134)');
            expect(deSlides[2].nativeElement.clientWidth).toBe(268, 'width of 3th slide is twice bigger then common slide');
        }));
    });
    ...
    describe(`THE OPTION 'AUTOWIDTH'`, () => {
        it(
            `should set custom width of slides [options]="{autoWidth: true}`,
            waitForAsync(() => {
                const html = `
        <div style="width: 1200px; margin: auto">
      ...
      `;
        ...
        it(
            `shouldn\'t set custom width of slides if autoWidth=false [options]="{autoWidth: false}`,
            waitForAsync(() => {
                const html = `
        <div style="width: 1200px; margin: auto">
    ...
    it(
        `should add navigation buttons  [options]="{nav: true}`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should set custom content on navigation buttons [options]="{nav: true, navText: [ '<i class=fa-chevron-left></i>', '<i class=fa-chevron-right></i>' ]}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    `;
            ...
            fixtureHost.whenStable().then(() => {
                ...
                prevButton = deNavButtons[0].nativeElement;
                nextButton = deNavButtons[1].nativeElement;
                expect(prevButton.firstElementChild.classList.contains('fa-chevron-left')).toBeTruthy(
                    'fa-chevron-left is class of child <i> Element of prev button',
                );
                expect(nextButton.firstElementChild.classList.contains('fa-chevron-right')).toBeTruthy(
    ...
    it(
        `should render carousel without dots [options]="{dots: false}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render dot for every x or additional slide (if items=3 and number of all slides is 5, there are 2 additional slides) [options]="{dotsEach: true}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with 3 dots [options]="{dotsEach: 4}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with dots with text [options]="{dotsData: true}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render carousel with dots with html in [options]="{dotsData: true}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
        <owl-carousel-o [options]="{ dotsData: true}">
    ...
    it(
        `should render carousel with dots with empty string in [options]="{dotsData: true}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
        <owl-carousel-o [options]="{ dotsData: true}">
    ...
    it(
        `should prev button be enabled when loop=true in [options]="{loop: true}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render 2 dots with [options]="{loop: true, merge: true}" and without defined [dataMerge]`,
        waitForAsync(() => {
            const html = `
      <div style="width: 1200px; margin: auto">
    ...
    it(
        `should render 4 dots with [options]="{autoWidth: true}" and undefined [width]`,
        waitForAsync(() => {
            const html = `
      <div style="width: 920px; margin: auto">
        <owl-carousel-o [options]="{ autoWidth: true}">
    ...
    it(
        `should render 2 dots and make next nav button disabled; [options]="{startPosition: 4, nav: true}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 920px; margin: auto">
    ...
    it(
        `should render 2 dots and shouldn't make next nav button disabled; [options]="{startPosition: 4, nav: true, rewind: true}"`,
        waitForAsync(() => {
            const html = `
      <div style="width: 920px; margin: auto">
    ...
    describe(`THE OPTION 'SLIDEBY'`, () => {
      ...
      `;
            ...
            expect(deActiveSlides[0].nativeElement.innerHTML).toContain('Slide 1', 'Slide 1');
            expect(deNavButtons[0].nativeElement.classList.contains('disabled')).toBeTruthy(
            ...
            expect(deNavButtons[1].nativeElement.classList.contains('disabled')).toBeTruthy(
      ...
      `;
            ...
            expect(deActiveSlides[0].nativeElement.innerHTML).toContain('Slide 1', 'Slide 1');
            expect(deNavButtons[0].nativeElement.classList.contains('disabled')).toBeFalsy(
            ...
            expect(deActiveSlides[0].nativeElement.innerHTML).toContain('Slide 8', 'Slide 8');
            expect(deDots[3].nativeElement.classList.contains('active')).toBeTruthy('1th dot is active');
            expect(deNavButtons[1].nativeElement.classList.contains('disabled')).toBeFalsy(
    ...
    `;
        ...
        expect(testComponent.currentSlidesData.startPosition).toBe(1, '1 startPosition');
        expect(testComponent.currentSlidesData.slides[0].id).toBe('owl-slide-2', 'owl-slide-2');
